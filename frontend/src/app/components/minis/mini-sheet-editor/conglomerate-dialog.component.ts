  ...
  template: `
    ...
    <mat-dialog-content>
      <mat-form-field appearance="outline" class="full-width">
        ...
        <input matInput [(ngModel)]="newSheetName" placeholder="Combined Sheet" />
      </mat-form-field>
      ...
      <div class="selection-actions">
        ...
        <span class="selection-count">{{ selectedCount }} selected ({{ totalMiniCount }} minis)</span>
      </div>
        ...
        @for (item of filteredSheets; track item.sheet.id) {
          ...
          >
            ...
            <div class="sheet-info">
              ...
              <span class="mini-count">{{ item.sheet.placements.length }} minis</span>
            </div>
          </div>
        }
      </div>
